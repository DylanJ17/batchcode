...
with tab2:
    ...
    # ✅ Trigger rerun after processing completes to activate Download CSV (keeps summary visible)
    if st.session_state.processing_complete and not st.session_state.results_df.empty:
        st.session_state.processing_complete = False
