        ...
        if code_input:
            ...
            if valid and interpretations:
                ...
                st.session_state.results_df = pd.DataFrame([{
                    ...
                    'Production Date': format_datetime(interpretations[0]['production_date'], include_day_name=False),
                    'Expiry Date': format_datetime(interpretations[0]['expiry_date'], include_day_name=False),
